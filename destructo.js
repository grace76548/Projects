...
console.log(`Visible shadow: ${visibleShadow}, Hidden shadows: ${hiddenShadows}`);
...
revealPath({direction: "South", distance: 1000});
...
mixPotion({ingredient1: "Stardust"});
mixPotion({ingredient1: "Apple Seeds", ingredient2: "Lime Zest"});
...
castSpell(["Quartz", "Coffee Beans", "Maple Leaf"]);
